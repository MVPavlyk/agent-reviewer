...
CREATE TABLE "run_context_docs" (
	"run_id" uuid NOT NULL,
	"path" text NOT NULL,
	"content_hash" text,
	"source" text NOT NULL,
	CONSTRAINT "run_context_docs_run_id_path_pk" PRIMARY KEY("run_id","path")
);
--> statement-breakpoint
...
ALTER TABLE "run_context_docs" ADD CONSTRAINT "run_context_docs_run_id_agent_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "public"."agent_runs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "agent_context_docs_path_idx" ON "agent_context_docs" USING btree ("path");--> statement-breakpoint
CREATE INDEX "skill_context_docs_path_idx" ON "skill_context_docs" USING btree ("path");