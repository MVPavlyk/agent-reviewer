...
/* Derived from the editor's own tab descriptors — a hardcoded list here
   silently swallows any tab added to TABS (the Context tab shipped broken
   that way): ?tab= fell through the check and reset to "config". */
